...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyLassiXyz.LessonPageTemplate();
  });
  ...
  describe('LessonPageTemplate', function() {
    it('should create an instance of LessonPageTemplate', function() {
      // uncomment below and update the code to test LessonPageTemplate
      //var instance = new MyLassiXyz.LessonPageTemplate();
      //expect(instance).to.be.a(MyLassiXyz.LessonPageTemplate);
    });
