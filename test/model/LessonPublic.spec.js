...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyLassiXyz.LessonPublic();
  });
  ...
  describe('LessonPublic', function() {
    it('should create an instance of LessonPublic', function() {
      // uncomment below and update the code to test LessonPublic
      //var instance = new MyLassiXyz.LessonPublic();
      //expect(instance).to.be.a(MyLassiXyz.LessonPublic);
    });
